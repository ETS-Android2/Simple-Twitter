...
In order to make infinite pagination work, make sure you are querying `max_id` instead of `maxId`.
Also, make sure that your URL has `statuses` instead of `status`.
